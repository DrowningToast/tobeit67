    ...
    >
      ...
      <article className="grid place-items-center px-8 md:px-20 xl:px-36 mt-0 mb-12">
        <div
          ...
          className="w-full p-6 md:px-20 md:py-12 rounded-[40px] grid grid-cols-2 gap-y-4 md:mt-12 md:gap-x-4"
        >
          ...
          <div className="w-full flex justify-end md:row-span-2 md:w-full md:grid md:place-items-center md:justify-end ">
            <div className="w-24 md:w-48 lg:w-64 xl:w-96">
              <Image
          ...
          <div className="col-span-2 md:col-span-1 font-noto flex flex-col gap-y-2 md:gap-y-4 text-black md:text-xl md:mt-16">
            ...
            <p>
              โครงการที่จะพาน้องๆ มาเรียนรู้พื้นฐานในโลกไอที
              ทั้งบนโลกออนไลน์และภายในคณะฯ
              ผ่านกิจกรรมเสริมความรู้วิชาการด้านเทคโนโลยีสารสนเทศให้แก่สังคม
              โดยพี่ๆ คณะเทคโนโลยีสารสนเทศ สจล.
            </p>
          </div>
